...
freac::freacGUI::freacGUI()
{
	...
	mainWnd->SetMinimumSize(Size(680, 460 + (config->GetIntValue(Config::CategorySettingsID, Config::SettingsShowTitleInfoID, Config::SettingsShowTitleInfoDefault) ? 68 : 0)));
