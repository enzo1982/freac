...
freac::freacGUI::freacGUI()
{
	...
	hyperlink		= new Hyperlink(String(freac::website).Replace("http://", NIL).Replace("/", NIL), NIL, freac::website, Point(91, -22));
