...
BonkEnc::DonateDialog::DonateDialog()
{
	...
	text_thanks		= new Text(BonkEnc::i18n->TranslateString("Thank you very much!"), Point(7, text_donate->GetUnscaledTextHeight() + text_donate_other->GetUnscaledTextHeight() + 129));
