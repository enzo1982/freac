...
extern "C"
{
  ...
  ID3_C_EXPORT bool                  ID3Tag_AttachFrame          (ID3Tag *tag, ID3Frame *frame);
  ...
  ID3_C_EXPORT size_t                ID3Tag_ParseBuffer          (ID3Tag *tag, const uchar *buffer, size_t bytes);
  ...
  ID3_C_EXPORT size_t                ID3Tag_Render               (const ID3Tag *tag, uchar *buffer, ID3_TagType tt);
  ...
  ID3_C_EXPORT bool                  ID3Field_SetEncoding        (ID3Field *field, ID3_TextEnc enc);
