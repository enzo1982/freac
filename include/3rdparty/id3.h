...
#define CCONV
  ...
  ID3_C_EXPORT size_t               CCONV ID3Tag_ParseBuffer          (ID3Tag *tag, const uchar *buffer, size_t bytes);  ID3_C_EXPORT size_t               CCONV ID3Tag_Link                 (ID3Tag *tag, const char *fileName);
