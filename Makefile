...
$(OBJECTDIR)/job_convertworker.o: $(SRCDIR)/jobs/engine/convertworker.cpp
	$(ECHO) -n Compiling $(SRCDIR)/jobs/engine/convertworker.cpp...
	$(COMPILER) $(COMPILER_OPTS) $(SRCDIR)/jobs/engine/convertworker.cpp -o $(OBJECTDIR)/job_convertworker.o
	$(ECHO) done.
