...
REMOVER = rm
ECHO = echo
COMPILER_OPTS = -I$(INCLUDEDIR1) -I$(INCLUDEDIR2) -m32 -march=i586 -Os -g0 -Wall -fno-exceptions -DUNICODE -D_UNICODE -DFAACAPI=__stdcall -DID3LIB_LINKOPTION=LINKOPTION_USE_DYNAMIC -c
...
$(OBJECTDIR)/freac.o: $(SRCDIR)/freac.cpp
	$(ECHO) -n Compiling $(SRCDIR)/freac.cpp...
	$(COMPILER) $(COMPILER_OPTS) -DBEEXPORT="__declspec (dllexport)" $(SRCDIR)/freac.cpp -o $(OBJECTDIR)/freac.o
	$(ECHO) done.
