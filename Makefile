...
LINKER_OPTS = -L$(LIBDIR1) -L$(LIBDIR2) -Xlinker --dynamicbase -Xlinker --nxcompat -lboca -lsmooth -llisa -lunicows -lshell32 -lws2_32 -lole32 -lwinmm -lstdc++ -mwindows --shared -Xlinker --out-implib -Xlinker $(LIBNAME) -o$(DLLNAME)
LOADER_COMPILER_OPTS = -I$(INCLUDEDIR2) -march=i586 -Os -g0 -Wall -fno-exceptions -c
LOADER_GUI_LINKER_OPTS = -L$(LIBDIR1) -Xlinker --dynamicbase -Xlinker --nxcompat -lsmooth -lstdc++ -mwindows -o$(EXENAME)
LOADER_CONSOLE_LINKER_OPTS = -L$(LIBDIR1) -Xlinker --dynamicbase -Xlinker --nxcompat -lsmooth -lstdc++ -o$(CMDNAME)
REMOVER_OPTS = -f
STRIP = strip
