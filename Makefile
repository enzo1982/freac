...
LINKER_OPTS = -L$(LIBDIR1) -lsmooth -lunicows -lshell32 -lwsock32 -lole32 -lstdc++ -mwindows -o$(EXENAME)
CMDLINKER_OPTS = -L$(LIBDIR1) -lsmooth -lunicows -lshell32 -lwsock32 -lole32 -lstdc++ -o$(CMDNAME)
REMOVER_OPTS = -f
STRIP = strip
